...
import static com.example.vves.workshop12.MainActivity.calendar_global;
...
public class CalendarHeader extends RelativeLayout implements RefreshHeader {

    public static String REFRESH_HEADER_PULLDOWN = "TRAGE";
    ...
    public static String REFRESH_HEADER_LASTTIME = "CALENDAR M-d HH:mm";
...
//    protected DateFormat mFormat = new SimpleDateFormat(REFRESH_HEADER_LASTTIME, Locale.CHINA);
    ...
    public CalendarHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public CalendarHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public CalendarHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onStateChanged(RefreshLayout refreshLayout, RefreshState oldState, RefreshState newState) {
        Log.i ("Calendar state", String.valueOf(calendar_global));
        if (!calendar_global) {
            REFRESH_HEADER_RELEASE = "DESCHIDE";
        }
        else {
            REFRESH_HEADER_RELEASE = "INCHIDE";
        }
        switch (newState) {
            case None:
...
//    }
    ...
    public CalendarHeader setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }
    public CalendarHeader setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }
    public CalendarHeader setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }
    public CalendarHeader setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }
    public CalendarHeader setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }
    public CalendarHeader setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public CalendarHeader setLastUpdateTime(Date time) {
        mLastTime = time;
        mLastUpdateText.setText("Calendar");
    ...
    public CalendarHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public CalendarHeader setTimeFormat(DateFormat format) {
        //mFormat = format;
        if (mLastTime != null) {
            mLastUpdateText.setText("Calendar");
        }
    ...
    public CalendarHeader setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public CalendarHeader setPrimaryColor(@ColorInt int primaryColor) {
    ...
    public CalendarHeader setAccentColor(@ColorInt int accentColor) {
    ...
    public CalendarHeader setPrimaryColorId(@ColorRes int colorId) {
        setPrimaryColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public CalendarHeader setAccentColorId(@ColorRes int colorId) {
        setAccentColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public CalendarHeader setFinishDuration(int delay) {
        mFinishDuration = delay;
        return this;
    }

    public CalendarHeader setEnableLastTime(boolean enable) {
    ...
    public CalendarHeader setTextSizeTitle(float size) {
    ...
    public CalendarHeader setTextSizeTitle(int unit, float size) {
    ...
    public CalendarHeader setTextSizeTime(float size) {
    ...
    public CalendarHeader setTextSizeTime(int unit, float size) {
    ...
    public CalendarHeader setTextTimeMarginTop(float dp) {
        return setTextTimeMarginTopPx(DensityUtil.dp2px(dp));
    }

    public CalendarHeader setTextTimeMarginTopPx(int px) {
    ...
    public CalendarHeader setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
    }

    public CalendarHeader setDrawableMarginRightPx(int px) {
    ...
    public CalendarHeader setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public CalendarHeader setDrawableSizePx(int px) {
    ...
    public CalendarHeader setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public CalendarHeader setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public CalendarHeader setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public CalendarHeader setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
